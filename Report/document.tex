...
\chapter{Aplicação}
  ...
  A aplicação desenvolvida consiste de três componentes principais: o \emph{front-end} construído com de
...
\chapter{Distribuição do Trabalho}
   ...
   O uso da ferramenta \var{Flask} foi indicado por Gustavo, de modo inspirado por arquivos de instruções auxiliares
